...
class SarOvrar(models.Model):
    ...
    sar_ovrar_reason = models.TextField()
    sar_ovrar_approved_by = models.CharField(max_length=9)
...
class ScrOvmrk(models.Model):
    ...
    scr_ovmrk_mkid = models.ForeignKey('StlMarks', models.DO_NOTHING, db_column='scr_ovmrk_override_mkid')
    scr_ovmrk_mark_avg = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
