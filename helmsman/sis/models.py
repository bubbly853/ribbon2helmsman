...
class ScbMjrcm(models.Model):
    scb_mjrcm_mrid = models.ForeignKey(SclMajor, on_delete=models.CASCADE, db_column='scb_mjrcm_mrid', related_name='campus_links')
    scb_mjrcm_cpid = models.CharField(max_length=2, db_comment='Campus ID.')

    class Meta:
        managed = False
        app_label = 'sis'
        db_table = 'student.scb_mjrcm'
