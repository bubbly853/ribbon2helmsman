...
class SclCurrv(models.Model):
    ...
    scl_currv_effective_term = models.ForeignKey('SglTerms', models.DO_NOTHING, db_column='scl_currv_effective_term')
    scl_currv_end_term = models.ForeignKey('SglTerms', models.DO_NOTHING, db_column='scl_currv_end_term')
