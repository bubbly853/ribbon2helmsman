...
class SclCurrv(models.Model):
    ...
    scl_currv_effective_term = models.CharField(max_length=6, db_comment='Term when this curriculum version becomes effective.')
    scl_currv_end_term = models.CharField(max_length=6, blank=True, null=True, db_comment='Term when this curriculum version is no longer active (NULL if current).')
